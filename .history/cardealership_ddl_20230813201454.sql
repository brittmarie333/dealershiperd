...
ALTER TABLE service_ticket ADD FOREIGN KEY (car_id) REFERENCES cars(car_id);

ALTER TABLE service_history ADD FOREIGN KEY (svc_ticket_id) REFERENCES service_ticket(svc_ticket_id);

ADD column_name service_ticket